...
public class ExpenseDaoTest {
    ...
    @Test
    void create_expense() {
        this.testExpense = this.testExpenseDao.createExpense(3, BigDecimal.valueOf(1201.50), "new web slinger for Spidey dao test");
    ...
    void get_expense_by_id() {
        ...
        Expense e = this.testExpenseDao.getExpenseById(this.testExpense.getExpenseId());
        System.out.println(e);
        Assertions.assertNotNull(e);
        Assertions.assertEquals("pending", e.getStatus());
        Assertions.assertEquals(3, e.getRequester());
    }
